...
//                        LocalDate dob = LocalDate.parse(input.nextLine(), DateTimeFormatter.ISO_LOCAL_DATE);
//
...
//                        student4.setDateOfBirth(dob);
//                        student4.setCombination(combination);
//                        student4.setSchool(school);
//                        student4.setLevel(level);
//
//                        Student student = new Student(101, fName, lName, dob, school, combination, level);
//
//
//
//                        int result = stmt.executeUpdate(
//                                "INSERT INTO student (firstName, lastName, age, school, combination, level) VALUES ('" + student.getFirstName() + "', '" + student.getLastName() + "', " + student.getDateOfBirth() + ", '" + student.getSchool() + "', '" + student.getCombination() + "', " + student.getLevel() + ")"
//                        );
//
//                        if (result > 0) {
//                            System.out.println("Student inserted successfully" + student.toString());
//                        } else {
...
//                                LocalDate dob = LocalDate.parse(db, DateTimeFormatter.ISO_LOCAL_DATE);
//                                String school = res.getString("school");
//                                String combination = res.getString("combination");
//                                int level = res.getInt("level");
//
//                                Student student1 = new Student(id, firstName,lastName, dob, school, combination, level);
...
//These are the codes to insert data into the database.
